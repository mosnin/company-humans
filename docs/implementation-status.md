...
- Migrations through0061 are applied on hosted verification and production. Migration0062 and the ready-state reader changes are locally verified but not yet released. Seven reference products remain catalog entries, not live integrations. Restricted credentials stay in ignored environment files.
